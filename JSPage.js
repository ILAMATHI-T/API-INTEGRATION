...
var Latitude;
var Longitude;
var key = "a53854c5a6c653509f914555ae23c8b9";  // Replace this with your API key
...
// Function to fetch the Latitude and Longitude from position data
...
// Fetching the JSON file and printing it to the paragraph
function fetchData(data) {
    const icon = "http://openweathermap.org/img/wn/" + data.weather[0].icon + "@2x.png";

    document.getElementById("data").innerHTML =
        "<b>The weather report of your Location is :-</b><br> <img src=" + icon + "><br>"
        + "<b>Country :</b>" + data.sys.country
        + "<br><b>Local Area Name :</b>" + data.name + "<br><b>Temp. :</b>"
        + parseFloat((data.main.temp - 273.15)).toFixed(1) + "℃"
        ...
        + "<br><b>Weather :</b>" + data.weather[0].description + "<br>";
}
